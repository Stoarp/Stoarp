...
namespace Stoarp.APIClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.revolt.chat";
        ...
        public Configuration(
            ...
            string basePath = "https://api.revolt.chat") : this()
        {
        ...
        {
            string report = "C# SDK (Stoarp.APIClient) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 0.11.3\n";
